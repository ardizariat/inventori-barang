                        ...
                        <form action="{{ route('produk.update', $data->id) }}" method="POST"
                            ...
                            <div class="container-fluid">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-md-10">
                                        <select title="Pilih gudang" data-live-search="true" name="gudang_id"
                                            ...
                                            <option @if ($data->gudang_id == $gudang->id) selected @endif
                                                value="{{ $gudang->id }}">
                                                {{ $gudang->nama }}
                                            </option>
                                            @endforeach
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" name="satuan" value="{{ $data->satuan }}" autocomplete="off"
                                            class="satuan form-control" placeholder="Masukkan satuan produk">
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col-md-2 ">
