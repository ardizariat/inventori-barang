...
<head>
  ...
  <link href="{{ asset('auth/vendor/izitoast/css/iziToast.min.css') }}" rel="stylesheet" type="text/css">
                ...
                <div class="p-5">
                  ...
                  <form class="user" method="POST" action="{{ route('login') }}">
                    ...
                    <div class="form-group">
                      <input type="email" class="form-control form-control-user" id="exampleInputEmail" name="email" autocomplete="off" placeholder="Email">
                    </div>
                    <div class="form-group">
                    ...
                    <hr>
                    <a href="{{ route('register') }}" class="btn btn-outline-dark btn-user btn-block">
                         Daftar
                    </a>
                  </form>
                  <hr>
